...
/// </remarks>
public class CollisionTrackingDemoLarge : Demo
{
    /// <summary>
    ...
    public class CollisionTracker : IDisposable
    {
        ...
        void PrepareForNextTimestep(float dt, IThreadDispatcher dispatcher)
        {
            ...
            Console.WriteLine($"PrepareForNextTimestep: {profiler.Elapsed.TotalMilliseconds}");
        }
        ...
        void Flush(float dt, IThreadDispatcher threadDispatcher)
        {
            ...
            Console.WriteLine($"Flush: {profiler.Elapsed.TotalMilliseconds} Count: {Tracked.Count}");
        }
